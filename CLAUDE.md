...
Critic/review loop convergence markers in `## Open Questions`: `[FIRST-TURN]`, `[CONVERGED]`, `[BLOCKED-CEILING]`, `[BLOCKED-AMBIGUOUS]`, `[BLOCKED-CATEGORY]`. Full policy: `reference/critic-loop.md` §Loop convergence.
