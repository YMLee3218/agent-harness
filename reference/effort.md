...
**Honest BLOCK**: if a correct solution cannot be determined, append `[BLOCKED:spec] {scope}: ambiguous — {reason}` to `## Open Questions` and stop. Do not deliver a partial or fake solution silently.
