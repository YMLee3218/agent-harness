...
# Clear all at once with: plan-file.sh unblock. Exception: [BLOCKED:ceiling] requires reset-milestone {agent} — never unblock alone (see @reference/markers.md §Clearing stop markers).
